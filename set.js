...
global.caption = "*© ❦ 𝗗𝗘𝗘𝗣_𝗧𝗛𝗜𝗡𝗞𝗘𝗥 ☙*"; // Input Yours custom...(Maintain font for Flow)
...
global.footer = "*❦ 𝗗𝗘𝗘𝗣_𝗧𝗛𝗜𝗡𝗞𝗘𝗥 ☙*"; // Input Yours custom...(Maintain font for Flow)
...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~Pn5hRYrQ#37_kz7tps80wvGTV_ W_DEnaW-TN_hUGVVpEqJ7tZz-l", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "923189392995,923043350457", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NAME: process.env.OWNER_NAME || "❦ 𝗔𝗪𝗔𝗜𝗦_𝗜𝗤𝗕𝗔𝗟 ☙", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "❦ 𝗔𝗪𝗔𝗜𝗦_𝗜𝗤𝗕𝗔𝗟 ☙", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "❦ 𓆩𝗪𝗔𝗦𝗜_𝗞𝗜𝗡𝗚࿐ ☙💜", // Added // Input Yours custom...
...
BOT_NAME: process.env.BOT_NAME || "❦ 𓆩𝗪𝗔𝗦𝗜_𝗞𝗜𝗡𝗚࿐ ☙", // Input Yours custom...(Maintain font for Flow)
BOT_PIC: process.env.BOT_PIC || "https://i.ibb.co/Y7ShZr1/1707932883908-1.jpg", // You can Replace with yours...
