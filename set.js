...
global.caption = "*©❦ 𝗔𝗪𝗔𝗜𝗦_𝗜𝗤𝗕𝗔𝗟 ☙*"; // Input Yours custom...(Maintain font for Flow)
...
global.footer = "*❦ 𓆩𝗪𝗔𝗦𝗜_𝗞𝗜𝗡𝗚࿐ ☙*"; // Input Yours custom...(Maintain font for Flow)
...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~KmIUTBQD#HQzqn5EMOYPvWPI4KtlOn8mBpxATTl8S0BvKvpPy2tg", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "923043350457", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NAME: process.env.OWNER_NAME || "❦ 𓆩𝗪𝗔𝗦𝗜_𝗞𝗜𝗡𝗚࿐ ☙", // Input Yours custom...(Maintain font for Flow)
...
BOT_NAME: process.env.BOT_NAME || "❦ 𝗔𝗪𝗔𝗜𝗦_𝗜𝗤𝗕𝗔𝗟 ☙", // Input Yours custom...(Maintain font for Flow)
BOT_PIC: process.env.BOT_PIC || "https://i.imgur.com/ZH9fbGp.jpeg", // You can Replace with yours...
