...
global.caption = "*©𝟐𝟎𝟐𝟒 𝗔𝗪𝗔𝗜𝗦 𝐌𝐃 𝐕𝟓*"; // Input Yours custom...(Maintain font for Flow)
...
global.footer = "*𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬 𝗔𝗪𝗔𝗜𝗦 𝗜𝗤𝗕𝗔𝗟*"; // Input Yours custom...(Maintain font for Flow)
 
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~PupSWbBC#SxspQ1qo5EE5U9faSsf-PNuCqv0Mc_H-hsegvGU_2U8", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "923189492995,923043350457", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NAME: process.env.OWNER_NAME || "𝗔𝗪𝗔𝗜𝗦", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "𝗔𝗪𝗔𝗜𝗦", // Added // Input Yours custom...
...
BOT_NAME: process.env.BOT_NAME || "𝗔𝗪𝗔𝗜𝗦-𝗠𝗗", // Input Yours custom...(Maintain font for Flow)
BOT_PIC: process.env.BOT_PIC || "https://i.imgur.com/ZfFRRmZ.jpeg", // You can Replace with yours...
